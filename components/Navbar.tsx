...
const categories = [
  {
    ...
    cname: "Chairs",
    description:
      "Experience comfort and support with our ergonomic chairs, designed to promote better posture and long-lasting productivity.",
    image: "pc/bgchair.png",
  },
  {
    name: "OFFICE TABLES",
    cname: "Tables",
    description:
      "Sturdy, elegant tables crafted to enhance both workspaces and living areas, combining practicality with timeless design.",
    image: "pc/table.png",
  },
  {
    name: "STORAGE SYSTEMS",
    cname: "Storage Systems",
    description:
      "Simplify your space with modern storage solutions that balance functionality, durability, and a clean, organized look.",
    image: "pc/bgstorage.png",
  },
  {
    name: "BOARDS",
    cname: "Boards",
    description:
      "From meetings to brainstorming sessions, our boards provide clear, reliable surfaces to share ideas and drive collaboration.",
    image: "pc/board.png",
  },
  {
    name: "PODIUMS",
    cname: "Podiums",
    description:
      "Professional podiums designed to add confidence and presence to every presentation, meeting, or public address.",
    image: "pc/bgpodium.png",
  },
  {
    name: "SOFAS",
    ...
    <>
      <nav className="border-b border-border sticky top-0 z-50 backdrop-blur-sm bg-background/95">
        ...
        <div className="hidden lg:block">
          ...
          {/* Categories Row - Full Width Red Background */}
          <div className="w-full bg-gradient-to-r from-[#D7263D] to-[#B91C3C]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                ...
                <div className="flex items-center space-x-6">
                  {categories.map((category) => (
                    <div
                      ...
                      onClick={() => handleCategoryClick(category.cname)}
                    >
                      <button className="flex items-center px-3 py-2 text-sm font-semibold text-white hover:text-gray-200 hover:underline font-montserrat">
                        {category.name}
                      </button>

                      {hoveredCategory === category.name && (
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[600px] bg-background border border-border rounded-lg shadow-lg p-6 animate-fade-in-up">
                ...
                <div className="flex items-center space-x-3">
                   ...
                   <Button
                    variant="ghost"
                    className="font-semibold text-sm text-white hover:text-red-500 font-montserrat hover:cursor-pointer"
                  ...
                  <a
                    href="https://wa.me/7416157474"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button className="bg-[#25D366] hover:bg-[#22c55e] text-white font-semibold hover:cursor-pointer">
                      <MessageCircle className="h-4 w-4 mr-2" />
                      WhatsApp
                    </Button>
                  </a>
        ...
        <div className="lg:hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <button
                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                className="p-2 text-foreground hover:text-[#D7263D]"
              >
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40">
          <div
            ...
            onClick={() => setIsMobileMenuOpen(false)}
          />
          <div className="fixed top-16 left-0 right-0 bg-background border-b border-border shadow-xl max-h-[calc(100vh-4rem)] overflow-y-auto animate-fade-in-up">
            <div className="h-1 bg-gradient-to-r from-[#D7263D]/0 via-[#D7263D] to-[#D7263D]/0" />

            <div className="px-6 py-8">
              <h2 className="text-2xl font-bold text-[#D7263D] mb-2 font-poppins">
                Our Products
              </h2>
              ...
              <div className="space-y-3 mb-10">
                {categories.map((category, index) => (
                  ...
                  >
                    <div className="bg-muted/10 rounded-xl border border-border shadow-sm hover:shadow-md transition-all">
                      <div className="flex items-center justify-between p-4">
                        <button
                          onClick={() => handleCategoryClick(category.cname)}
                          className="font-bold text-lg text-left font-montserrat"
                        >
                          {category.name}
                        </button>
                        <button
                      ...
                      {expandedMobileCategory === category.name && (
                        <div className="px-4 pb-6">
                          <div className="rounded-lg p-4 border border-border/30">
                            <img
                              src={category.image}
                              alt={category.name}
              ...
              <div className="space-y-3 pt-6 border-t border-border">
                <Button
                  variant="outline"
                  className="w-full font-semibold text-lg h-14 bg-gradient-to-r from-[#D7263D] to-[#B91C3C] text-white font-montserrat"
                  onClick={handleCatalogClick}
                >
                  OUR CATALOGUE
                </Button>
                <Button
                  className="w-full font-semibold text-lg h-14 font-montserrat text-white hover:text-black"
                  onClick={handleContactClick}
                >
                  CONTACT US
                </Button>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <Button className="w-full h-14 bg-[#25D366] text-white font-bold text-lg">
